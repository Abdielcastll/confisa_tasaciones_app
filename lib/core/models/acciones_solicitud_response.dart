...
TipoAccionesSolicitudResponse tipoAccionesSolicitudResponseFromJson(
        String str) =>
    TipoAccionesSolicitudResponse.fromJson(json.decode(str));

String tipoAccionesSolicitudResponseToJson(
        TipoAccionesSolicitudResponse data) =>
    json.encode(data.toJson());

class TipoAccionesSolicitudResponse {
  ...
  List<TipoAccionesSolicitudData> data;
  String nextPageUrl;
  int totalCount, pageSize, currentPage, totalPages;
  bool hasNextPage, hasPreviousPage;

  factory TipoAccionesSolicitudResponse.fromJson(Map<String, dynamic> json) =>
      TipoAccionesSolicitudResponse(
          data: json["data"]
              .map<TipoAccionesSolicitudData>(
                  (e) => TipoAccionesSolicitudData.fromJson(e))
              .toList(),
          totalCount: json["meta"]["totalCount"],
          totalPages: json["meta"]["totalPages"],
          pageSize: json["meta"]["pageSize"],
...
class TipoAccionesSolicitudData {
  TipoAccionesSolicitudData({required this.id, required this.descripcion});

  String descripcion;
  int id;

  factory TipoAccionesSolicitudData.fromJson(Map<String, dynamic> json) =>
      TipoAccionesSolicitudData(
        id: json["id"] ?? 0,
